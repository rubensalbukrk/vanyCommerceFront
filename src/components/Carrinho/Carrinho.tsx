...
const Carrinho = () => {
  const {total} = useCarrinho();
    ...
    return (
        <Button 
        className='flex w-12 justify-center items-center bg-blue-500
        ...
        title="" onClick={() => alert('MEU CARRINHO')}>
          <div className="w-5 h-5 absolute top-1 right-0 bg-red-600 rounded-xl justify-center items-center">
